...
(deftest diamond
  (is (= [[1 0] [2 1] [3 0] [4 1] [3 2] [2 1] [1 2] [0 1] [1 0]]
         (concave-hull test-data-diamond))))

(deftest dumbbell
  (is (= [[1 0] [2 1] [3 1] [4 0] [5 1] [4 2] [3 1] [2 1] [1 2] [0 1] [1 0]]
         (concave-hull test-data-dumbbell))))

(deftest katya
  (is (= solution-katya (concave-hull test-data-katya))))
